...
<section class="py-5">
  <?php
     ...
     $converted_id = (int)$id;
     // echo gettype($converted_id);
    
        $data = $products->SingleProduct($converted_id);
    ...
    <div class="row gx-5">
      <aside class="col-lg-6">
        ...
        <div class="border rounded-4 mb-3 d-flex justify-content-center">
          <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/detail1/big.webp">
            ...
            src="admin\<?php echo $row['picture']; ?>" />
          </a>
        </div>
      ...
      <main class="col-lg-6">
        ...
        <div class="ps-lg-3">
          ...
          <div class="mb-3">
            <span class="h5"><?php echo $row['price']; ?></span>
          ...
          <div class="row">
            <dt class="col-3">Call:</dt>
            <dd class="col-9">0548127506</dd>
            ...
            <div class="card-body">
              ...
              <div class="d-flex">
                ...
                <div class="info">
                  ...
                  <strong class="text-dark"><?php echo $row['price']; ?></strong>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col-12 col-lg-3 col-sm-12 mb-2">
          ...
          <p class="mt-1 text-white">
            © 2023 Copyright: msservicentrade.com
          </p>
        </div>
        <!-- Grid column -->
