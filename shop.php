...
<section>
  <div class="container my-5">
    ...
    <div class="row">
     ...
     $user_products = $products->DisplayProduct();
     foreach($user_products as $row){?>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
        <div class="card w-100 my-2 shadow-2-strong">
          <img src="admin\<?php echo $row['picture'];?>" class="card-img-top" style="aspect-ratio: 1 / 1" />
          <div class="card-body d-flex flex-column">
            <h5 class="card-title"><?php echo $row['title']?></h5>
            <p class="card-text"><?php echo $row['price']?></p>
            <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
              <a href="product-details.php?id=<?php echo $row['id']; ?>" class="btn btn-primary shadow-0 me-1">View More</a>
